...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        $('.gear-black-left').css({transform: 'rotate(' + (5*180 * percent/100) + 'deg)'});
        $('.gear-grey-left').css({transform: 'rotate(' + (10*180 * percent/100) + 'deg)'});
        $('.gear-black-right').css({transform: 'rotate(-' + (5*180 * percent/100) + 'deg)'});
        $('.gear-grey-right').css({transform: 'rotate(-' + (10*180 * percent/100) + 'deg)'});
    });
});